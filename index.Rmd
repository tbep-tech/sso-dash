---
title: "Sanitary Sewer Overflow (SSO) risk probabilities, Pinellas County, Florida"
output: 
...
plos <- reactive({
  ...
  p1 <- plot_ly(toplo) %>%
    ...
    add_segments(x = dtssel[1], xend = dtssel[2], y = prbsel, yend = prbsel, line = list(color = 'black', dash = 'dot'), highlight = F) %>% 
    layout(
